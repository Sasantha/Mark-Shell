...
const AdminEditMaterialPage = ({ params }: { params: Promise<{ id: string }> }) => {
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Update existing material details.</p>
                </div>
            </div>
...
export default AdminEditMaterialPage;
