...
const EditPartnerPage = ({ params }: { params: Promise<{ id: string }> }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const logoUrl = imageFile ? await uploadImageToCloudinary(imageFile) : existingLogo;
    ...
    const displayPreview = imagePreview || existingLogo;
        ...
        <div className="max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Edit Business Partner</h1>
                </div>
                <div className="flex gap-3">
                    ...
                    <Button
                        ...
                        disabled={isSaving}
                    >
                        {isSaving ? <><Loader2 size={16} className="animate-spin mr-2" /> Saving...</> : <><Save size={16} className="mr-2" /> Update Partner</>}
                    </Button>
                </div>
            </div>
